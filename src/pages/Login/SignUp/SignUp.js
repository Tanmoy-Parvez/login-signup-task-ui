...
const SignUp = () => {
    const { signUpUser, authError } = useFirebase()
        ...
        <div>
            <div className="container my-4 pt-5">
                <div className="row d-flex align-items-center">
                    <div className="col-md-7 text-center animate__animated animate__backInRight">
                        <img src={loginImg} alt="" className="img-fluid d-block" />
                        <Link to="/home">
